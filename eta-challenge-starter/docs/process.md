...
| + zone_pair_hour_mean (min count=30) + is_unknown_zone (current master) | 272.3s | 270.9s | ~20 min | superseded |
| **+ pair_speed_kmh (haversine * 3600 / zone_pair_mean)** | **271.9s** | **270.5s** | ~18 min | **merged to master** |
